      ...
      >
        <div className="flex items-start gap-4 md:gap-5">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between gap-2 h-8 md:h-12">
            ...
            <div className={`grid transition-all duration-300 ${openTag ? 'grid-rows-[1fr] opacity-100 mt-2' : 'grid-rows-[0fr] opacity-0 md:group-hover:grid-rows-[1fr] md:group-hover:opacity-100 md:group-hover:mt-1'}`}>
      ...
      >
        <div className="flex items-start gap-4 md:gap-5">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className={`grid transition-all duration-300 ${openShield ? 'grid-rows-[1fr] opacity-100 mt-2' : 'grid-rows-[0fr] opacity-0 md:group-hover:grid-rows-[1fr] md:group-hover:opacity-100 md:group-hover:mt-1'}`}>
              <p className="overflow-hidden text-[10px] md:text-xs font-bold text-slate-500 dark:text-white/40 leading-relaxed">
